...
#                    )
    ...
    try:
        httpresp = urllib.urlopen("http://%s/verify" % VERIFY_SERVER, params)

        # get the return values
        result_values = httpresp.read().splitlines()

        # get the return code (true/false)
        return_code = result_values[0]
        ...
        if return_code == "true":
            ...
            return RecaptchaResponse (is_valid=False, error_code = result_values [1])
